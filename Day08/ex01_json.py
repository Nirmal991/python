...
p1 = {"name": "Vinod", "city": "Bangalore", "emails": ["vinod@vinod.co", "vinod@cyblore.com"], "age": 53, "married": True, "job": None}
...
print(f'There are {movies['totalResults']} movies related word `spider`')   
